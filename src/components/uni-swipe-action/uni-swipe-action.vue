<template>
	<div class="uni-swipe-action">
		<div class="uni-swipe-action__container" :class="{'uni-swipe-action--show':isShowBtn}" @touchstart="touchStart"
		 @touchmove="touchMove" @touchend="touchEnd" @touchcancel="touchEnd" @click="bindClickCont" :style="{'transform':transformX,'-webkit-transform':transformX}">
			<div class="uni-swipe-action__content">
				<slot></slot>
			</div>
			<div class="uni-swipe-action__btn-group" :id="elId">
		...
		<div class="uni-swipe-action__mask" v-if="isShowBtn" @click="close" @touchmove.stop.prevent="close"></div>
	</div>
</template>
