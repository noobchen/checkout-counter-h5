<template>
	<div>
		<div class="uni-calendar__box">
			<div class="uni-calendar__wrapper">
				<div class="uni-calenda__content">
					<div class="uni-calendar__panel">
						<div class="uni-calendar__date-befor" @tap="dataBefor('0', 'month')">
							<text class="iconfont icon-jiantou"></text>
						</div>
						<div class="uni-calendar__panel-box">
							<div>{{ canlender.year }}年</div>
							<div>{{ canlender.month }}月</div>
						</div>
						<div class="uni-calendar__date-after uni-calendar__rollback" @tap="dataBefor('1', 'month')">
							<text class="iconfont icon-jiantou "></text>
						</div>
						<div class="uni-calendar__backtoday" @tap="backtoday">回到今天</div>
					</div>
					<div v-if="lunar" class="uni-calendar__day-detail">
						<div>
							{{
								canlender.year +
									'年' +
					...
					<div class="uni-calendar__header">
						<div class="uni-calendar__week">日</div>
						<div class="uni-calendar__week">一</div>
						<div class="uni-calendar__week">二</div>
						<div class="uni-calendar__week">三</div>
						<div class="uni-calendar__week">四</div>
						<div class="uni-calendar__week">五</div>
						<div class="uni-calendar__week">六</div>
					</div>
