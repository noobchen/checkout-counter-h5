<template>
	<div :class="['uni-collapse-cell',{'uni-collapse-cell--disabled':disabled,'uni-collapse-cell--open':isOpen}]" :hover-class="disabled ? '' : 'uni-collapse-cell--hover'">
		<div class="uni-collapse-cell__title" @click="onClick">
			<div class="uni-collapse-cell__title-extra" v-if="thumb">
			...
			<div class="uni-collapse-cell__title-arrow" :class="{'uni-active':isOpen,'uni-collapse-cell--animation':showAnimation===true}">
				<uni-icon color="#bbb" size="20" type="arrowdown"></uni-icon>
			</div>
		</div>
		<div class="uni-collapse-cell__content" :class="{'uni-collapse-cell--animation':showAnimation===true}" :style="{height:isOpen ? height : '0px'}">
			<div :id="elId">
				<slot />
			</div>
		</div>
