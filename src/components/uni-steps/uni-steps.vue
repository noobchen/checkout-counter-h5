<template>
	<div class="uni-steps">
		<div class="uni-steps-items" :class="'uni-steps-' + direction">
			<div class="uni-steps-item" v-for="(item,index) in options" :key="index" :class="{'uni-steps-process':index === active,'uni-steps-finish':index < active}">
				<div class="uni-steps-item-title-container" :style="{color:index === active ? activeColor : ''}">
