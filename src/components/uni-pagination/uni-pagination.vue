<template>
	<div class="uni-pagination">
		<div class="uni-pagination__btns">
			<div @click="clickLeft" :class="['uni-pagination__btn',{'uni-pagination--disabled':currentIndex === 1}]"
			...
			<div @click="clickRight" :class="['uni-pagination__btn',{'uni-pagination--disabled':currentIndex === maxPage}]"
